...
const char*   MQTT_DEVICEID   = "motor01";              // *앱에 등록한장비ID
...
//const char*   ssid        = "KT_GIGA_811A";                  // * WIFI ID
//const char*   password    = "cf10bd1580";               // * WIFI 비번
...
//Motor
#define DIRECT_PIN  12  // IN1
#define BREAK_PIN   13  // IN2